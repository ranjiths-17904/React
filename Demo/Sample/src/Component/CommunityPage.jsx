...
const CommunityPage = () => {
  ...
  return (
    ...
    <div className="bg-[#030303] text-white font-sans">
      ...
      <div className="overflow-hidden shadow-md rounded-md bg-[#1F1F1F] mx-2 sm:mx-6">
  ...
  <ul>
    {Array(3).fill("").map((_, index) => (
      <li key={index} className="bg-[#141313] p-2 mb-2 rounded text-blue-400 flex flex-col">
        <div className="flex items-center">
          ...
          <div className="ml-5 text-base font-medium">
            Project Name
            <div className="text-sm text-gray-500 -mr-4">Project description</div>
          </div>
        </div>
        <ProgressBar />
      </li>
