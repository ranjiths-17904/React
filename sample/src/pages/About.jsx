...
const About = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center p-7 bg-white shadow-xl rounded-lg w-full max-w-screen-lg mx-auto">
      <div className="lg:w-1/3 w-full flex flex-col items-center lg:items-start mb-8 lg:mb-0">
        ...
        >
          ...
          />
          <FaJsSquare className="absolute -right-10 top-28 mt-3 text-4xl text-yellow-500 hover:text-yellow-600 transition-transform transform hover:scale-110" />
          <FaReact className="absolute -right-0 top-36 mt-3 text-4xl text-blue-400 hover:text-blue-500 transition-transform transform hover:scale-110" />
          <FaHtml5 className="absolute right-16 top-40 mt-3 text-4xl text-red-500 hover:text-red-600 transition-transform transform hover:scale-110" />
        </div>
