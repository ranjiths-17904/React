  ...
  return (
    <div className="flex flex-col lg:flex-row items-start p-8 bg-gradient-to-b from-purple-900 to-blue-600 rounded-lg shadow-xl w-full max-w-screen-lg mx-auto">
      ...
      <div className="lg:w-1/3 w-full flex flex-col items-center lg:items-start mb-6 lg:mb-0">
        ...
        <button
          type="button"
          className="relative flex justify-center gap-2 items-center mx-auto shadow-xl text-lg bg-white backdrop-blur-md font-semibold border border-gray-300 hover:border-emerald-500 transition-all duration-700 rounded-full px-5 py-2 overflow-hidden group"
        >
          Download Resume
          <svg
